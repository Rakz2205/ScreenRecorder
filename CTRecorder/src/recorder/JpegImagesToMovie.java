...
public boolean doIt(int width, int height, int frameRate, @SuppressWarnings("rawtypes") Vector inFiles,
...
class ImageDataSource extends PullBufferDataSource {
    ...
    ImageDataSource(int width, int height, int frameRate, @SuppressWarnings("rawtypes") Vector images) {
...
class ImageSourceStream implements PullBufferStream {
    ...
    public ImageSourceStream(int width, int height, int frameRate,
            @SuppressWarnings("rawtypes") Vector images) {
        this.width = width;
        this.height = height;
        this.images = images;
